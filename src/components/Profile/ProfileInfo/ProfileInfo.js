...
const ProfileData = ({ profile, isOwner, goToEditMode }) => {
  return (
    <div>
      ...
      <div >
        <b>Contacts:</b> {Object.keys(profile.contacts).map(contact => (
          <Contact contactTitle={contact} contactValue={profile.contacts.contact} key={contact} />))}
      </div>
    </div>
  )
}
...
const Contact = ({ contactTitle, contactValue }) => {
  return <div className={s.descriptionBlock__contacts}>
